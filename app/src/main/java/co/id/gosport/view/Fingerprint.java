...
import co.id.gosport.callback.FailAuthCounterCallback;
import co.id.gosport.callback.FingerprintCallback;
import co.id.gosport.callback.FingerprintSecureCallback;
import co.id.gosport.utils.CipherHelper;
...
public class Fingerprint extends RelativeLayout {
    ...
    private Runnable checkForLimit = new Runnable() {
        ...
        public void run() {
            if(counterCallback!=null && ++tryCounter==limit){
                counterCallback.onTryLimitReached(co.id.gosport.view.Fingerprint.this);
            }
        }
    };
     ...
     */
    public co.id.gosport.view.Fingerprint callback(FingerprintCallback fingerprintCallback){
     ...
     * @return the Fingerprint object itself
     */
    public co.id.gosport.view.Fingerprint callback(FingerprintSecureCallback fingerprintSecureCallback, String KEY_NAME){
     ...
     * @return the Fingerprint object itself
     */
    public co.id.gosport.view.Fingerprint cryptoObject(FingerprintManager.CryptoObject cryptoObject){
     ...
     * @return the Fingerprint object itself
     */
    public co.id.gosport.view.Fingerprint tryLimit(int limit, FailAuthCounterCallback counterCallback){
        this.limit = limit;
     ...
     * @return the Fingerprint object itself
     */
    public co.id.gosport.view.Fingerprint delayAfterError(int delayAfterError){
